    ...
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        ...
        <p>
          ...
          <p>
            taggy is here to give you an open-source frontend
            module to help you with your tagging needs.
          </p>
        </p>
        <GifPlayer
        ...
        <div className="padding-top--md">
          <p>
            taggy is currently under development. You can watch the development
            status on{" "}
